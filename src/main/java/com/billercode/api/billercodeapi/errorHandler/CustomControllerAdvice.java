package com.billercode.api.billercodeapi.errorHandler;

import com.billercode.api.billercodeapi.exceptions.CustomDataNotFoundException;
import com.billercode.api.billercodeapi.exceptions.CustomErrorException;
import com.billercode.api.billercodeapi.exceptions.CustomParameterConstraintException;
import com.billercode.api.billercodeapi.exceptions.CustomTimeoutException;
import com.billercode.api.billercodeapi.models.ErrorResponse;
...
class CustomControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleCustomTimeoutExceptions(Exception e) {

        HttpStatus status = HttpStatus.REQUEST_TIMEOUT; // 404
