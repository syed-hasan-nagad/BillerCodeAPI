...
public class SendHTTPRequest {
    ...
    public static String sendHttpRequest(String requestMethod, int timeout, Map<String, Object> requestPayload, URL endpointUrl, Map<String,String> headers) throws IOException {
